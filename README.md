...
$ apigee-analytics-collector export traffic --help
  ...
  Options:
    ...
    -E, --select <select_columns>                                  Return metrics in a single request e.g. sum(message_count),avg(total_response_time). More info https://goo.gl/fv69d2. Default sum(message_count)
    ...
    -T, --apigee_mgmt_token <apigee_mgmt_token>                    Token generated by Apigee Edge Management API. Learn more https://goo.gl/8PrIZ4.
