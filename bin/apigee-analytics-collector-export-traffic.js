...
program
    ...
    .option("-T, --apigee_mgmt_token <apigee_mgmt_token>", "Token generated by Apigee Edge Management API. Learn more https://goo.gl/8PrIZ4.")
...
function get_base_options( options, suffixArray, qs ) {
  ...
  var apigee_mgmt_token = options.apigee_mgmt_token || process.env.apigee_mgmt_token;
  ...
  if (!(apigee_mgmt_api_email && apigee_mgmt_api_password) && !apigee_mgmt_token) {
    throw new Error('Make sure apigee_mgmt_api_email, apigee_mgmt_api_password, or apigee_mgmt_token are set');
  } else if (apigee_mgmt_api_email && apigee_mgmt_api_password) {
      authorization_header = "Basic " + new Buffer( ( apigee_mgmt_api_email ) + ":" +
                                ( apigee_mgmt_api_password )).toString("base64");
  } else if(apigee_mgmt_token) {
      authorization_header = 'Bearer ' + apigee_mgmt_token;
  }
